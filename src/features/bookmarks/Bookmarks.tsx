      ...
      <div className="max-w-[1100px] mx-auto px-6 lg:px-10 py-8 space-y-6">
        ...
        {items.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <button onClick={() => { void navigate('/tenant/map'); }} className="bg-primary text-primary-foreground px-6 py-2.5 rounded-xl text-[13px] font-bold hover:bg-primary/90 transition-colors">
              Explore Map
            </button>
          </div>
        )}
            ...
            <AnimatePresence>
              {items.map((bh, i) => (
                <motion.div 
                  ...
                  transition={{ duration: 0.2, delay: i * STAGGER_DELAY }}
                ...
                >
                  ...
                  <div className="p-4 space-y-3">
                    <div>
                      <h3 
                        onClick={() => { void navigate(`/tenant/map/roomet/${bh.id}`); }} 
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      {bh.amenities.slice(0, MAX_AMENITIES).map((a: string) => (
              ...
              {items.map((bh, _i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-bold truncate cursor-pointer hover:text-primary transition-colors" onClick={() => { void navigate(`/tenant/map/roomet/${bh.id}`); }}>
                      {bh.name}
                    </p>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button onClick={() => { void navigate(`/tenant/map/roomet/${bh.id}`); }} className="w-8 h-8 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition-colors">
