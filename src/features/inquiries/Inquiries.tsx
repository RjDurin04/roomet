...
import { Send, Search as SearchIcon, ShieldCheck, MapPin, ExternalLink, Image as ImageIcon, Trash2, X } from 'lucide-react';
...
export function Inquiries() {
  ...
  return (
    <div className="flex h-full w-full bg-background overflow-hidden">
      ...
      <div className="w-[340px] flex-shrink-0 border-r border-border bg-card flex flex-col h-full">
        {/* Header */}
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground/80 mb-1 truncate">{chat.property.name}</p>
      ...
      {activeChat ? (
        <div className="flex-1 flex flex-col bg-background relative">
          {/* Chat Header */}
          <div className="h-[72px] border-b border-border bg-card/80 backdrop-blur flex items-center justify-between px-6 shrink-0 z-10 sticky top-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground flex items-center gap-1">
                  ...
                  <span className="text-border">·</span> Owner of {activeChat.property.name}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1">
              <button 
                onClick={() => navigate(`/tenant/map/roomet/${activeChat.property.id}`)}
          ...
          <div 
            onClick={() => navigate(`/tenant/map/roomet/${activeChat.property.id}`)}
            className="mx-6 mt-4 flex items-center gap-3 p-3 bg-card border border-border rounded-xl cursor-pointer hover:border-primary/30 transition-colors group z-0"
          >
            <div className="w-14 h-14 rounded-lg overflow-hidden bg-muted shrink-0 border border-border/50">
