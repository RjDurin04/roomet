  ...
  return (
    <div className="flex h-screen w-screen bg-background overflow-hidden text-foreground selection:bg-primary/20 font-sans">
      ...
      <aside className="w-[72px] flex-shrink-0 flex flex-col items-center py-6 border-r border-border/50 bg-card z-50 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        {/* Brand/Logo */}
        <Link to="/owner" className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground flex items-center justify-center font-black text-lg mb-8 shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
          B
        </Link>
        ...
        <div className="mt-auto flex flex-col items-center gap-3 w-full px-3 pt-6 border-t border-border/50 relative">
          ...
          <Link to="/owner/settings" title="Settings" className="flex items-center justify-center w-12 h-12 text-muted-foreground hover:text-foreground hover:bg-muted rounded-xl transition-colors">
